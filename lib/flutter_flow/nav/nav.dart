...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? SelectserviceWidget() : LoginpageWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: HelpcentreWidget.routeName,
          path: HelpcentreWidget.routePath,
          builder: (context, params) => HelpcentreWidget(),
        ),
        FFRoute(
          name: HelpmesasagesWidget.routeName,
          path: HelpmesasagesWidget.routePath,
          builder: (context, params) => HelpmesasagesWidget(),
        ),
        FFRoute(
          name: MessagecentreWidget.routeName,
          path: MessagecentreWidget.routePath,
          builder: (context, params) => MessagecentreWidget(),
        ),
        FFRoute(
          name: SelectserviceWidget.routeName,
          path: SelectserviceWidget.routePath,
          builder: (context, params) => SelectserviceWidget(),
        ),
        FFRoute(
          name: TransitWidget.routeName,
          path: TransitWidget.routePath,
          builder: (context, params) => TransitWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: Bookingpagenew3Widget.routeName,
          path: Bookingpagenew3Widget.routePath,
          builder: (context, params) => Bookingpagenew3Widget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: WaitingpageWidget.routeName,
          path: WaitingpageWidget.routePath,
          asyncParams: {
        ...
        FFRoute(
          name: HistorypagenewWidget.routeName,
          path: HistorypagenewWidget.routePath,
          builder: (context, params) => HistorypagenewWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: SoftwareLicensesWidget.routeName,
          path: SoftwareLicensesWidget.routePath,
          builder: (context, params) => SoftwareLicensesWidget(),
        ),
        FFRoute(
